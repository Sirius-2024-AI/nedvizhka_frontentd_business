...
function App() {
    return ( 
        ...
        <div className='flex flex-col items-center pt-11 bg-black text-white '>
            ...
            <h2 className="mt-20 text-6xl font-bold text-center text-white w-[760px] max-md:mt-10 max-md:max-w-full max-md:text-4xl">
                <span className="bg-clip-text text-transparent bg-gradient-to-r font-mabry from-cyan-300 to-blue-500">готовый API </span> <br></br> для вашего бизнеса
            </h2>
            <Features />
            <ClientExperience />
