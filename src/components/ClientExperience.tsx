...
const ClientExperience: React.FC = () => {
  return (
    <section className="flex overflow-hidden relative flex-col justify-center items-center px-16 py-20 mt-12 w-full text-center text-white max-w-[1025px] min-h-[285px] rounded-[30px] max-md:px-5 max-md:mt-10 max-md:max-w-full">
      <img
        loading="lazy"
      ...
      <div className="flex relative flex-col mt-3.5 mb-2.5 max-w-full w-[623px]">
        <h2 className="self-center text-4xl font-mabry max-md:max-w-full">
          улучшайте <span className="text-white">клиентский опыт</span>
        </h2>
